...
```{r}
# TODO: Tie it back to which country actually had this.
gapminder %>%
  group_by(continent, country) %>%
  mutate(gain = lifeExp - lag(lifeExp, 3))  %>%  # Sharpest drop is the smallest gain, therefore min!
  filter(!is.na(gain)) %>% 
...
# Canada has higher most probably, relatively!
